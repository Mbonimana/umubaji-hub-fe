    ...
    <div className="min-h-screen bg-[#F5F5F5] flex">
      ...
      <div className="flex-1 ml-64 flex flex-col">
        ...
        <main className="flex-1 pt-20 p-6 overflow-y-auto">
          <h1 className="text-2xl font-semibold text-[#5a4632] mb-4">Settings</h1>
            ...
            <div className="bg-white rounded-xl shadow border border-gray-100 p-6 max-w-2xl">
              {!editMode ? (
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    <button onClick={() => setEditMode(true)} className="px-4 py-2 rounded-md bg-[#4B341C] text-white hover:opacity-90">
                      Edit Profile
                    </button>
                  </div>
                </div>
                ...
                <>
                  ...
                  <div className="mt-6 flex gap-2">
                    <button onClick={onSave} className="px-4 py-2 rounded-md bg-[#4B341C] text-white hover:opacity-90">
                      Save Changes
                    </button>
